...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'expenses'];
        }
     ...
     * {@inheritDoc}
     */
    public function addExpense(\App\Entity\Expense $expense): static
    {
     ...
     * {@inheritDoc}
     */
    public function removeExpense(\App\Entity\Expense $expense): static
    {
