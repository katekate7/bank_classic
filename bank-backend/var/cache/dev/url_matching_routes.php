...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/login' => [[['_route' => 'api_user_login', '_controller' => 'App\\Controller\\ApiLoginController::login'], null, ['POST' => 0], null, false, false, null]],
        '/api/register' => [[['_route' => 'api_user_register', '_controller' => 'App\\Controller\\ApiRegistrationController::register'], null, ['POST' => 0], null, false, false, null]],
